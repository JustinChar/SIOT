...
admin.initializeApp({
  storageBucket: "siot-2bfb8.firebasestorage.app",
});
...
const emailTransporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "justin.charsan.c@gmail.com", // Replace with your Gmail address
    pass: "qmmljmaziebwssgp", // Replace with your app-specific password
  },
});
...
exports.sendLatestPdf = functions.pubsub.topic('send-latest-pdf').onPublish(async (message) => {
  ...
  try {
    ...
    const emailDetails = {
      from: "justin.charsan.c@gmail.com", // Your email
      to: "justin.fifa2022@gmail.com", // Recipient's email
